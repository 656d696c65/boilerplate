...
import { askForActivationUserTokenRouteDefinition } from "@boilerplate/metadata/routes"
...
export const askForActivationUserTokenRoute = routeHandler({
    definition: askForActivationUserTokenRouteDefinition,
    handler: async ({ context }) => {
        ...
        //     context: context,
        //     schema: askForActivationUserTokenRouteDefinition.schemas.input
        // })
